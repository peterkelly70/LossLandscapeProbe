...
def generate_comparison_plots(data, output_dir):
    ...
    resource_levels = sorted([float(level) for level in data.keys()])
    resource_percentages = [int(level * 100) for level in resource_levels]
    ...
    # Plot 3: Efficiency (Accuracy/Time) vs Resource Level
    ...
    plt.title('Training Efficiency vs Resource Level', fontsize=14)
    plt.grid(True, linestyle='--', alpha=0.7)
    plt.xticks(resource_percentages)
...
<head>
    ...
    <title>{dataset_display} Resource Level Comparison</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>{dataset_display} Resource Level Comparison</h1>
        ...
        <div class="plot-container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Test Accuracy vs Resource Level</h3>
                    <img src="{os.path.basename(plot_files['accuracy'])}" alt="Accuracy vs Resource Level" class="img-fluid">
        ...
        <div class="plot-container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Training Time vs Resource Level</h3>
                    <img src="{os.path.basename(plot_files['time'])}" alt="Training Time vs Resource Level" class="img-fluid">
        ...
        <div class="plot-container">
            <div class="row">
                <div class="col-md-12">
                    <h3>Training Efficiency vs Resource Level</h3>
                    <img src="{os.path.basename(plot_files['efficiency'])}" alt="Efficiency vs Resource Level" class="img-fluid">
